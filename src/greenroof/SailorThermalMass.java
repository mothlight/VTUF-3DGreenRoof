...
public class SailorThermalMass
{
        ...
        public double dt = 60; //seconds between measurements
        public double interface_heat_flux; // Heat flux at the interface                
        ...
        public int  samples;
        public final static int ONE = Constants.ONE;
        public final static int TWO = Constants.TWO;


        
        
        
    public void SailorThermalMass_(Plant plant, Substrate sub, Roof roof, int n_substrate_layers, int n_roof_layers, double Area, double dt)
    { 
            dt = dt*60;
            ...
            innerT = interp1([0 (sub.depth+roof.depth)],[obj.T_substrate obj.T_interior],obj.samples(2:end-1))';           
...
//            U=      Math.max(3,data.U);       // Wind speed [m/s]
//            W=      obj.VWC[ONE];    //VWC            
//            Latm = data.IR;   
//            
//            double[] TT = new double[]{obj.T_plants, obj.T_substrate};
//           
//            Tf = TT[Constants.ONE];
//            Tg = TT[Constants.TWO];
//            
...
//    }
//        
//  public void ResFUN(obj,TT,data)
//  {
//                                   
//            // Load constants
//            consts = Constants;
...
//        
//        
//      public void moveForward(obj,data)      
//      {
//            
//            obj = obj.setMatrices();
//            
...
//      }
//        
//      public void getTemperature(obj, depth)
//      {
